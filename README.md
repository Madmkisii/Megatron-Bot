...
**📌DEPLOY ON HEROKU**
   ...
   - ***`Get Session` by  [`PAIRING CODE`](https://megatronbot-84ed83378984.herokuapp.com/pair)
   - ***`Get Session` by  [`QR CODE`](https://megatronbot-84ed83378984.herokuapp.com/scan) Then `Go-to Whatapp>Three dots>Linked Devices`***
